...
genenames = open("/home/unix/rossin/DALY/PPI/NewCode/IWtoHugo",'r').readlines()
geneNameConvert={}
...
if (plot == 'true' and plotP == 'false') or (plot == 'true' and permutlength==0):
	...
	if plot=='true':
		...
		if manualColoring == 'false':
			if plotP == 'false':
				os.system("sed s/manualColoring/FALSE/g /home/unix/rossin/DALY/PPI/NewCode/plot.R | sed s/KEYWORDHERE/"+sys.argv[1]+"/g | sed s/COLLAPSEHERE/"+collapse+"/g > tmpPlot.R")
			else:
				os.system("sed s/manualColoring/FALSE/g /home/unix/rossin/DALY/PPI/NewCode/plotP.R | sed s/KEYWORDHERE/"+sys.argv[1]+"/g | sed s/COLLAPSEHERE/"+collapse+"/g > tmpPlot.R")			
		else:
			os.system("sed \'s/manualColoring/TRUE/g\' /home/unix/rossin/DALY/PPI/NewCode/plot.R | sed \'s/coloringScheme/"+manualColoring+"/g\' | sed \'s/KEYWORDHERE/"+sys.argv[1]+"/g\' > tmpPlot.R")
	...
	if plot=='true':
		...
		if manualColoring == 'false':
			if plotP == 'false':
				...
				os.system("sed s/manualColoring/FALSE/g /home/unix/rossin/DALY/PPI/NewCode/plotP.R | sed s/NPERMUTEHERE/"+str(permutlength)+"/g | sed s/KEYWORDHERE/"+sys.argv[1]+"/g | sed s/COLLAPSEHERE/"+collapse+"/g > tmpPlot.R")			
		else:
			os.system("sed \'s/manualColoring/TRUE/g\' /home/unix/rossin/DALY/PPI/NewCode/plot.R | sed \'s/coloringScheme/"+manualColoring+"/g\' | sed \'s/KEYWORDHERE/"+sys.argv[1]+"/g\' > tmpPlot.R")
		os.system("R --vanilla < tmpPlot.R")
