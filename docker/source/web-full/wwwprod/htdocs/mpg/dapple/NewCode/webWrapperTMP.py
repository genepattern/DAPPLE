...
if not genestospecify=='false':
	os.system("python /web/wwwprod/htdocs/mpg/dapple/NewCode/BuildNetwork_slowTMP.py "+seedFile+" permute="+str(permute)+" CIcutoff="+str(CIcutoff)+" specify="+genestospecify+" keyword="+keyword+" dir="+dir+" nearestgene="+nearestgene+" regulatory="+regulatory+" genome="+genome)
else:
	os.system("python /web/wwwprod/htdocs/mpg/dapple/NewCode/BuildNetwork_slowTMP.py "+seedFile+" permute="+str(permute)+" CIcutoff="+str(CIcutoff)+" keyword="+keyword+" dir="+dir+" nearestgene="+nearestgene+" regulatory="+regulatory+" genome="+genome)
