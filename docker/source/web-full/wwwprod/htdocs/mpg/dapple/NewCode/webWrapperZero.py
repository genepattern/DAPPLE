...
if not genestospecify=='false':
	os.system("python /web/wwwprod/htdocs/mpg/dapple/NewCode/BuildNetwork_slowTMP.py "+seedFile+" permute="+permute+" CIcutoff="+str(CIcutoff)+" plot="+str(plot)+" iterate="+iterate+" compare=true"+" specify="+genestospecify+" keyword="+keyword+" dir="+dir+" nearestgene="+nearestgene+" regulatory="+regulatory+" plotP="+plotP+" collapseCI="+collapseCI+" genome="+genome)
else:
	os.system("python /web/wwwprod/htdocs/mpg/dapple/NewCode/BuildNetwork_slowTMP.py "+seedFile+" permute="+permute+" CIcutoff="+str(CIcutoff)+" plot="+str(plot)+" iterate="+iterate+" compare=true keyword="+keyword+" dir="+dir+" nearestgene="+nearestgene+" regulatory="+regulatory+" plotP="+plotP+" collapseCI="+collapseCI+" genome="+genome)
...
os.system("zip "+keyword+"_results.zip "+keyword+"*"+" Seeds *GenesToPrioritize")
